...
def get_dataset(dset_name, batch_size, n_worker, data_root='/srv/datasets'):
    ...
    if dset_name == 'cifar10':
        ...
        n_class = 10
        trainset = datasets.CIFAR10(root='/home/riselabrtx1/Downloads/HAWQ_arun/hawq_arun/Pruning-and-Mixed-Precision-Quantization-of-Neural-Networks/data', 
                    train=True, 
                    download=False,
        ...
        valset = datasets.CIFAR10(root='/home/riselabrtx1/Downloads/HAWQ_arun/hawq_arun/Pruning-and-Mixed-Precision-Quantization-of-Neural-Networks/data', 
                            train=False, 
                            download=False,
                            transform=transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]))
